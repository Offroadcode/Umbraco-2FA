...
(function() {
   ...
   function PaginationDirective() {
      ...
      function link(scope, el, attr, ctrl) {
         ...
         var unbindTotalPagesNumberWatcher = scope.$watch('totalPages', function(newValue, oldValue){
            activate();
         });

         scope.$on('$destroy', function(){
           unbindTotalPagesNumberWatcher();
         });
      ...
      var directive = {
         restrict: 'E',
         replace: true,
         templateUrl: '/App_Plugins/Fortress/backoffice/directives/pagination.html',
         scope: {
            pageNumber: "=",
            totalPages: "=",
            onNext: "=",
      ...
      console.info("Got Directive Template", directive.templateUrl);
      return directive;

   }

   angular.module('umbraco.directives').directive('customPagination', PaginationDirective);
